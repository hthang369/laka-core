<?php
namespace Laka\Core\Forms;

use Illuminate\Support\Arr;
use Laka\Core\Forms\Fields\FormField;
use Laka\Core\Forms\Traits\FormHelper;
use Laka\Core\Forms\Traits\RendersForm;
...
abstract class Form
{
    ...
    public function addRequired($name, $type = Field::TEXT, $options = [])
    {
        return $this->add($name, $type, array_merge($options, ['required' => true]));
    }
    ...
    public function setFormOptions(array $options)
    {
        ...
        // $attr = array_pull($this->formOptions, 'attr');
        // foreach ($attr as $key => $value) {
        //     data_set($this->formOptions, $key, $value);
        // }
