...
use Laka\Core\Generators\ModuleGenerator;

class ModuleGenerateDeleteCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'module:generate-delete';
    ...
    public function handle()
    {
        ...
        $code = with(new ModuleGenerator($name))
            ...
            ->setSubFolder($this->argument('path'))
            ->delete();
